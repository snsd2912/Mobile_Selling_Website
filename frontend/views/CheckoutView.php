 				...
 				<form method="post" action="index.php?controller=Cart&action=doCheckout">
				 	...
				 	<div class="panel-body">
						...
						<div class="row" style="margin-bottom: 5px;">
							...
							<div class="col-md-10">
								<input type="text" required name="name" class="form-control" value="<?php echo $customer->name;?>">
							</div>
						</div>
						<div class="row" style="margin-bottom: 5px;">
							<div class="col-md-2">Address</div>
							<div class="col-md-10">
								<input type="text" required name="address" class="form-control" value="<?php echo $customer->address;?>">
							</div>
						</div>
						<div class="row" style="margin-bottom: 5px;">
							<div class="col-md-2">Phone number</div>
							<div class="col-md-10">
								<input type="text" required name="phone" class="form-control" value="<?php echo $customer->phonenumber;?>">
							</div>
						</div>
					</div>

					<div class="panel-body">
					 	<div style="text-transform:uppercase;font-weight:700;font-size:15px;margin-bottom: 20px;">HÌNH THỨC THANH TOÁN</div>
						<div class="radio">
							<label><input type="radio" name="optradio" value="airpay" checked>Airpay</label>
						</div>
						<div class="radio">
							<label><input type="radio" name="optradio" value="tcb">Techcombank</label>
						</div>
