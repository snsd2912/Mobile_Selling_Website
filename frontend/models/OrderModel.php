<?php 
	trait OrderModel{
		...
		public function listOrder($id, $from, $pageSize){
			//thuc thi truy van
			...
			$query = DB::fetchAll("select * from listorder where customerid=$id order by orderid desc limit $from, $pageSize");
        ...
        public function takeOrder($id){
			DB::execute("update listorder set ship=2 where orderid=$id");
		}
	}
 ?>