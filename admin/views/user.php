        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="nav-item" style="background-color: rgb(206, 206, 206)!important; border-radius: 25px; float: right!important;">                
                    <!-- search section  -->
                    <form class="form-inline" method="post" action="index.php?controller=users&action=search">
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            $query = $conn->query("select name from role where roleid=".$rows->roleid);
                            //lay mot ban ghi
                    ...
                    <td style="text-align:center;">
                        <a href="index.php?controller=users&action=edit&id=<?php echo $rows->userid; ?>">Edit</a>&nbsp;
                        <a href="index.php?controller=users&action=delete&id=<?php echo $rows->userid; ?>" onclick="return window.confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
                <?php 
                    $number++;
