...
<div class="col-md-12">
    <div style="margin-bottom:5px;">
        <?php if($order->ship == 1): ?>
            <a href="#" class="btn btn-danger">Đang giao hàng</a>
        <?php elseif($order->ship == 2): ?>
            <a href="#" class="btn btn-success">Đã nhận hàng</a>
        <?php else: ?>
            <a href="index.php?controller=Order&action=sent&id=<?php echo $order->orderid; ?>" class="btn btn-primary">Xác nhận đã giao hàng</a>
        <?php endif; ?>
    </div>
